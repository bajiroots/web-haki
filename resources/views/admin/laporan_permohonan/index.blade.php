    ...
    <div class="main-wrapper container">
        <div class="row">
            <div class="col-xl mb-5">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title-lg">Laporan Permohonan</h5>
                    ...
                    <table id="myTable" class="table mt-3">
                        ...
                        <a href="{{url('/admin/downloadpdf?bulan='.$request->get('bulan').'&tahun='.$request->get('tahun'))}}" target="_blank" class="btn btn-info ntn-md">DOWNLOAD PDF</a> 
                <div>      
                    </div>
                </div>
            </div>
