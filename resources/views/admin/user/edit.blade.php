                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('user.update', $data->id) }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input id="email" type="email" class="form-control" name="email" placeholder="Enter email" required value="{{ $data->email }}">
                                        <span id="cEmail"></span>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input id="username" type="text" class="form-control" name="username" placeholder="Username" required value="{{ $data->username }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" placeholder="Nama Lengkap" required value="{{ $data->name }}">
                            </div>
                            <div class="form-group">
                                <label>No KTP <span class="required" style="color: red">*</span> </label>
                                <input type="number" class="form-control" name="no_ktp" placeholder="No KTP" required value="{{ $data->no_ktp }}">
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        <label>Tgl Lahir <span class="required" style="color: red">*</span> </label>
                                        <input type="date" class="form-control" name="tgl_lahir" placeholder="Tgl Lahir" required value="{{ $data->tgl_lahir }}">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea required name="alamat" class="form-control" cols="30" rows="10">{{ $data->alamat }}</textarea>
                            </div>
                            <div class="form-group">
                                <label>Kode POS <span class="required" style="color: red">*</span> </label>
                                <input type="number" class="form-control" name="kode_pos" placeholder="Kode POS" required value="{{ $data->kode_pos }}">
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control mb-3 js-states pasti" name="provinsi" required>
                                    ...
                                    @foreach (\Helper::provinsi() as $item)
                                        <option @if($item->id == $data->kota->provinsi_id) selected @endif value="{{ $item->id }}">{{ $item->nama_provinsi }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control mb-3" name="kota" required>
                                    @foreach ($kota as $item)
                                        <option @if($item->id == $data->kota_id) selected @endif value="{{ $item->id }}">{{ $item->nama_kota }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input placeholder="Kosongkan field ini jika tidak ingin mengubah password" id="password" type="password" class="form-control" name="password" minlength="8" >
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        <label>Confirm Password </label>
                                        <input placeholder="Kosongkan field ini jika tidak ingin mengubah password" id="cpassword" type="password" class="form-control" name="cpassword" minlength="8" >
                                    </div>
                                </div>
                            </div>
                            <span id="pesan"></span>
